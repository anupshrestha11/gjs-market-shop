...
const ProductQuestions: React.FC<ProductQuestionsProps> = ({
  ...
  return (
    <div className="block">
      <div className="-ml-4 flex w-[calc(100%+32px)] flex-col justify-between border-b border-t border-light-500 px-4 py-5 dark:border-dark-400 sm:flex-row sm:items-center md:mb-1 md:ml-0 md:w-full md:border-t-0 md:border-b-0 md:py-0 md:px-0">
        <h2 className="text-sm tracking-tight text-dark dark:text-light">
          Question and Answers ({paginatorInfo?.total ?? 0})
        </h2>
        <div className="mt-4 inline-flex flex-col-reverse items-start gap-2.5 sm:mt-0 sm:flex-col sm:items-end sm:pl-2 md:flex-row">
