...
const AverageRatings: React.FC<AverageRatingsProps> = ({
  ...
  return (
    <div className="-ml-4 flex w-[calc(100%+32px)] flex-col divide-y divide-light-500 border-t border-b border-light-500 px-4 py-6 dark:divide-dark-400 dark:border-dark-400 sm:flex-row sm:items-center sm:space-x-7 sm:divide-y-0 sm:divide-x sm:py-7 md:ml-0 md:w-full md:space-x-12 md:border-t-0 md:border-b-0 md:py-0 md:px-0 ">
