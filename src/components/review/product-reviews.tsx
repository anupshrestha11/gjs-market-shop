...
const ProductReviews: React.FC<ProductReviewsProps> = ({ productId }) => {
  ...
  return (
    <div className="block">
      <div className="-ml-4 flex w-[calc(100%+32px)] flex-col justify-between border-b border-light-500 px-4 py-5 dark:border-dark-400 sm:flex-row sm:items-center sm:py-4 md:ml-0 md:w-full md:px-0">
        <h2 className="text-sm tracking-tight text-dark dark:text-light">
          Product Reviews ({paginatorInfo?.total ?? 0})
        </h2>
